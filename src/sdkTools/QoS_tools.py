...
def qos_createQuarantedSubscription():
    ...
    equipment_network_identifier = str(os.getenv('UE_REQUESTED_IP'))    #"10.0.0.1"   
    ...
    notification_destination = os.environ['NEF_CALLBACK_URL']   #"http://10.161.1.114:8383/monitoring/callback" 
